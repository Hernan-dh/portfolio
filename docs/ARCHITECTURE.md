...
Static portfolio for Hernán de Haro. It presents his profile and projects, embeds Agentic Twin, Deep Research, AI Debate, Financial Researcher, and Stock Picker as external applications, and links to separately hosted AI Operations Desk and Event Ticketing & Access Control projects.
...
└── HTTPS iframes ── Agentic Twin, Deep Research, AI Debate, Financial Researcher, and Stock Picker on the portfolio host
```
...
AI Operations Desk and Sidekick are presented as static, versioned screenshots with isolated GitHub repository links. AI Operations Desk and Event Ticketing & Access Control have separate external project links because their hosts block iframe embedding; Sidekick has no hosted runtime exposed from the portfolio.
...
- Embedded application interactions belong to Agentic Twin, Deep Research, AI Debate, Financial Researcher, and Stock Picker. They are reached through same-origin HTTPS paths managed by the deployment reverse proxy.
- Each iframe receives only clipboard-write permission.
