const translations = {
  en: {
    ...
    researchSdk: 'The agent workflow uses the OpenAI Agents SDK and the official OpenAI Python SDK, connecting Gemini and Groq through OpenAI-compatible endpoints without depending on OpenAI models.',
  ...
  es: {
    ...
    researchSdk: 'El flujo de agentes utiliza OpenAI Agents SDK y el SDK oficial de OpenAI para Python, conectando Gemini y Groq mediante endpoints compatibles con OpenAI sin depender de modelos de OpenAI.',
